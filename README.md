...
This program parses user input, handles variable expansion, and executes commands by creating child processes. It supports a wide range of features including pipes, redirections, signals, and environment management.
...
The environment is managed via a linked list (`t_shenv`), allowing for dynamic modification of environment variables.
